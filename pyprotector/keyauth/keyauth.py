...
class Keyauth:
    ...
    def initialize(self) -> Union[bool, KeyauthAppData]:
        ...
        self._enc_key = SHA256.new(str(uuid.uuid4())[:8].encode()).hexdigest()
    ...
    def login(self, username: str, password: str, hwid: Optional[str] = None) -> KeyauthUser:
    ...
    def setvar(self, variable: str, data: str) -> None:
        ...
        Returns:
            None
        """
        response: Response = self.__request(self._post_data(type="setvar", data={"var": variable, "data": data}))
    ...
    def getvar(self, variable: str) -> str:
        ...
        Returns:
            str: Variable
        """
        response: Response = self.__request(self._post_data(type="getvar", data={"var": variable}))
    ...
    def var(self, variable: str) -> None:
        ...
        Returns:
            str: Variable
        """
        response: Response = self.__request(self._post_data(type="var", data={"varid": variable}))
    ...
    def checkBlacklist(self, hwid: Optional[str] = None) -> bool:
        ...
        response: Response = self.__request(self._post_data(type="checkblacklist", data={"hwid": hwid}))
    ...
    def getChat(self, channel: str) -> List[KeyauthChat]:
        ...
        """
        response: Response = self.__request(self._post_data(type="chatget", data={"channel": channel}))
    ...
    def sendChat(self, channel: str, message: str) -> str:
        ...
        Returns:
            str: Response
        """
        response: Response = self.__request(self._post_data(type="chatsend", data={"channel": channel, "message": message}))
    ...
    def download(self, file_id: str) -> bytes:
        ...
        Returns:
            bytes: Bytes Object
        """
        response: Response = self.__request(self._post_data(type="file", data={"fileid": file_id}))
    ...
    def changeUsername(self, username: str) -> bool:
        ...
        """
        response: Response = self.__request(self._post_data(type="changeUsername", data={"newUsername": username}))
    ...
    def log(self, user: str, message: str) -> None:
        ...
        Args:
            ...
            message (str): Message
        """
        self.__request(self._post_data(type="log", data={"user": user, "message": message}))
    ...
    def webhook(self, webhook_id: str, params: str) -> None:
        ...
        """
        self.__request(self._post_data(type="webhook", data={"webid": webhook_id, "params": params}))
